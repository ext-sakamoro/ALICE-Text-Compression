...
const plans = [
  { name: 'Free', price: '$0/mo', features: ['100MB/day', 'LZ4 + Gzip', 'Level 1-3 only', 'Community support'] },
  { name: 'Pro', price: '$19/mo', features: ['10GB/day', 'All 6 algorithms', 'All compression levels', 'Custom dictionaries', 'Priority support'] },
  { name: 'Enterprise', price: 'Custom', features: ['Unlimited data', 'Dedicated cluster', 'Custom algorithms', 'SLA guarantee', 'Dedicated support'] },
];
